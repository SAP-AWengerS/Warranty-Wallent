...
import { useWarranty } from "../src/Components/WarrantyContext/WarrantyContext";

// 🔹 Mock Axios
jest.mock("../src/Config/Axios/Axios", () => ({
  Axios: {
    get: jest.fn(),
  },
}));
...
jest.mock("../src/Components/WarrantyContext/WarrantyContext", () => ({
  useWarranty: jest.fn(),
}));

// 🔹 Mock WarrantyCard and Filters
jest.mock("../src/Components/WarrantyCard/WarrantyCard", () => ({
  __esModule: true,
  default: ({ warranty }) => <div data-testid="warranty-card">{warranty.itemName}</div>,
}));

jest.mock("../src/Components/Filters/Filters", () => ({
  __esModule: true,
